...
android {
    namespace = "com.playermatch.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.playermatch.app"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Compose BOM — all Compose versions aligned through BOM
    ...
    // Firebase BOM — all Firebase versions aligned through BOM
